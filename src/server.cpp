...
void send_response(const int client_fd, http_response_struct response, const int status_code, std::string_view body = "", std::string_view content_type = "text/plain") {
